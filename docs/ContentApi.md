...
api_instance = looker.ContentApi()
...
# create an instance of the API class
api_instance = looker.ContentApi()
body = looker.ContentFavorite() # ContentFavorite | Favorite Content (optional)
...
# create an instance of the API class
api_instance = looker.ContentApi()
body = looker.ContentMetaGroupUser() # ContentMetaGroupUser | Content Metadata Access (optional)
...
api_instance = looker.ContentApi()
content_metadata_id = 789 # int | Id of content metadata
body = looker.ContentMeta() # ContentMeta | Content Metadata
...
api_instance = looker.ContentApi()
content_metadata_access_id = 789 # int | Id of content metadata access
body = looker.ContentMetaGroupUser() # ContentMetaGroupUser | Content Metadata Access
