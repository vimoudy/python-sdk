...
api_instance = looker.GroupApi()
group_id = 789 # int | Id of group
body = looker.GroupIdForGroupInclusion() # GroupIdForGroupInclusion | Group id to add (optional)
...
api_instance = looker.GroupApi()
group_id = 789 # int | Id of group
body = looker.GroupIdForGroupUserInclusion() # GroupIdForGroupUserInclusion | User id to add (optional)
...
# create an instance of the API class
api_instance = looker.GroupApi()
body = looker.Group() # Group | Group (optional)
fields = 'fields_example' # str | Requested fields. (optional)
...
group_id = 789 # int | Id of group
user_attribute_id = 789 # int | Id of user attribute
body = looker.UserAttributeGroupValue() # UserAttributeGroupValue | New value for group.
