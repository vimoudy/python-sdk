...
api_instance = looker.IntegrationApi()
...
# create an instance of the API class
api_instance = looker.IntegrationApi()
body = looker.IntegrationHub() # IntegrationHub | Integration Hub (optional)
fields = 'fields_example' # str | Requested fields. (optional)
...
api_instance = looker.IntegrationApi()
integration_id = 789 # int | Id of Integration
body = looker.Integration() # Integration | Integration
fields = 'fields_example' # str | Requested fields. (optional)
...
api_instance = looker.IntegrationApi()
integration_hub_id = 789 # int | Id of Integration Hub
body = looker.IntegrationHub() # IntegrationHub | Integration Hub
fields = 'fields_example' # str | Requested fields. (optional)
