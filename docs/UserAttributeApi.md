...
api_instance = looker.UserAttributeApi()
...
# create an instance of the API class
api_instance = looker.UserAttributeApi()
body = looker.UserAttribute() # UserAttribute | User Attribute (optional)
fields = 'fields_example' # str | Requested fields. (optional)
...
api_instance = looker.UserAttributeApi()
user_attribute_id = 789 # int | Id of user attribute
body = [looker.UserAttributeGroupValue()] # list[UserAttributeGroupValue] | Array of group values.
...
api_instance = looker.UserAttributeApi()
user_attribute_id = 789 # int | Id of user attribute
body = looker.UserAttribute() # UserAttribute | User Attribute
fields = 'fields_example' # str | Requested fields. (optional)
